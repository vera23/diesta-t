...
class SliderModelSlider extends JModelAdmin
{
	 ...
	 * @since    1.6
	 */
	protected $text_prefix = 'COM_SLIDER';

	/**
	 * @var   	string  	Alias to manage history control
	 * @since   3.2
	 */
	public $typeAlias = 'com_slider.slider';
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_slider.edit.slider.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_slider'))
		{
