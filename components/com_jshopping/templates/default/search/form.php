...
<div class = "jshop" id="comjshop">
    ...
    <form action="<?php print $this->action?>" name="form_ad_search" method="<?php print $this->config->search_form_method?>" onsubmit="return validateFormAdvancedSearch('form_ad_search')" class = "form-horizontal">
