 ...
 */
function modChrome_bnone($module, &$params, &$attribs)
{
	echo $module->content;
}
 ...
 */
function modChrome_bhtml5($module, &$params, &$attribs)
{
 ...
 */
function modChrome_btable($module, &$params, &$attribs)
{ ?>
 ...
 */
function modChrome_bhorz($module, &$params, &$attribs)
{ ?>
 ...
 */
function modChrome_bxhtml($module, &$params, &$attribs)
{
	if (!empty ($module->content)) : ?>
 ...
 */
function modChrome_brounded($module, &$params, &$attribs)
{ ?>
 ...
 */
function modChrome_boutline($module, &$params, &$attribs)
{
	static $css = false;
	if (!$css)
	{
