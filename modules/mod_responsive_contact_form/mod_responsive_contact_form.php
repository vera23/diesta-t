<?php
/**
 * @package Module Responsive Contact Form for Joomla! 2.x
...
$document->addScript(JURI::base(true).'/modules/mod_responsive_contact_form/js/jquery.validate.min.js');
...
// Stylesheet
$document->addStylesheet(JURI::base(true).'/modules/mod_responsive_contact_form/css/bootstrap.min.css');
...
<section id="contact" class="content">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'];?>" method="POST" class="form-horizontal contact-form" id="contact-form">
	  ...
	  <fieldset>
		...
		<?php if($error) { echo '<div id="formResponse">'.$error.'</div><br/>'; }?>
		
		<!-- Name Field -->
		  <div class="control-group">
			<label class="control-label" for="inputName"><?php echo $params->get('ffield_name'); ?></label>
			<div class="controls">
			  <input class="input-80 required" name="name" type="text" id="inputName" placeholder="<?php echo $params->get('ffield_name'); ?>">
			</div>
		  </div>
		 ...
		 <!-- E-mail Field -->
		  ...
		  <div class="control-group">
			...
			<div class="controls">
			  <input class="input-80 <?php if($params->get('email_req')==1){ echo "required"; } ?>" name="email" type="text" id="inputEmail" placeholder="<?php echo $params->get('sfield_name'); ?>">
			</div>
		  </div>
		  <?php }
		  ...
		  <div class="control-group">
			...
			<div class="controls">
			  <input class="input-80 <?php if($params->get('phone_req')==1){ echo "required"; } ?> " name="phone" type="text" id="inputPhone" placeholder="<?php echo $params->get('tfield_name'); ?>">
			</div>
		  </div>
		  <?php
				}
		  ...
		  <div class="control-group">
			...
			<div class="controls">
				...
				<?php
					...
					{
				?>
						<input class="input-80 required" name="type" type="text" id="selectSubject" placeholder="<?php echo $params->get('fofield_name'); ?>">
				<?php
					}
				?>
			</div>
